...
$query = "
    SELECT u.username, u.email, u.role, s.admin_id, s.admin_role, s.fullName 
    FROM dbo.sibatta_user u
    INNER JOIN dbo.sibatta_admin s ON u.user_id = s.user_id
    WHERE u.username = ?
";
    ...
    <div id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item mb-3">
                <a class="nav-link text-dark d-flex align-items-center" href="mainAkademik.php">
